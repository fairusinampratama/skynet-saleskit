...
class UserPolicy
{
    ...
    public function view(User $user, User $model): bool { return $user->role === 'admin'; }
    ...
    public function restore(User $user, User $model): bool { return $user->role === 'admin'; }
    public function forceDelete(User $user, User $model): bool { return $user->role === 'admin'; }
}
