...
@php
    ...
    $selectClass = $style === 'portal'
        ? 'w-full rounded-xl border border-slate-200 bg-white/95 px-3.5 py-3 text-sm font-bold text-slate-950 shadow-sm outline-none transition focus:border-amber-400 focus:ring-4 focus:ring-amber-500/10'
